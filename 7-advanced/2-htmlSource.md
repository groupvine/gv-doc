...
elements, and some other default styling, wrap your custom HTML in a
class="gv-base-styling" element.  This could be done by adding this
class to an element that already wraps your email content, or adding
an overally ```<div>``` wrapper like this:
