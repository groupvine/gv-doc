...
## More Info or Get Started!

Like more information?  Ready to get started?
<a href="mailto:support@groupvine.com?subject=GoLocal%20Information%20Request&body=My%20website:%20%0D%0AQuestions:%20%0D%0A" target="_blank">
Send us</a> your website, and any 
questions and we'll get right back to you!   
...
You can read on for more details, or feel free to
<a href="mailto:support@groupvine.com?subject=GoLocal%20Information%20Request&body=My%20website:%20%0D%0AQuestions:%20%0D%0A" target="_blank">
email us</a> with any questions.

## Ad Image Types and Specifications

GroupVine 4 School communities can send emails using one of the
following two basic template formats.
...
The two Top Banner ads and the Side Square ad are
“Standard” ads, and priced the same. The Side Skyscraper
ad is a “Premium” ad, and priced 50% higher than the
Standard ads (see pricing below).

To ensure that your ad runs continuously, regardless of
which template the School chooses for their emails, we
suggest providing at least one ad image for Template One
and one for Template Two.
...
directly for higher volume pricing):
...
Yes, just let us know which schools your’d like to target and we can include your ad in their community emails.
...
* **What image formats are supported for the ads?**
Ad images should be provided using JPG, PNG, or GIF image
formats.  If you provide an ad image in a different
format, we can typically convert it for you.  Note that
animated GIFs are generally not supported, as they do not
work in many email readers.

* **What is the file size limit for the ad images?**
